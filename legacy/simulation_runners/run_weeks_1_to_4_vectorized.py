...
from src.nfl_sim.vectorized_game_engine import VectorizedNFLGameEngine
...
def run_weeks_vectorized():
    year = 2025
    iterations = 1000
    weeks = [1, 2, 3, 4]
    
    print("\n" + "="*80)
    print(" NFL 2025 SEASON - Weeks 1-4 High-Speed Vectorized Simulator")
